...
const reasons = [
  {
    ...
    shortdescription: 'Consultations, examens, soins,  et l’achat de médicaments.',
  }, {
    icon: 'family.svg',
    name: 'famille',
    ...
    shortdescription: 'Motif familial impérieux, pour l\'assistance aux personnes \
    vulnérables et précaires ou la garde d\'enfants.',
  }, {
    icon: 'handicap.svg',
    name: 'handicap',
    description: 'Déplacement des personnes en situation de handicap et leur accompagnant.',
    shortdescription: 'Déplacement des personnes en situation de handicap et leur accompagnant.',
  }, {
    icon: 'hangout.svg',
    name: 'sport_animaux',
    ...
    de compagnie.',
    shortdescription: 'Activité physique individuelle et besoins des animaux de compagnie.',
  }, {
    icon: 'legal.svg',
    name: 'convocation',
    description: 'Convocation judiciaire ou administrative et pour se rendre dans un service public',
    shortdescription: 'Convocation judiciaire ou administrative.',
  }, {
    icon: 'tig.svg',
    name: 'missions',
